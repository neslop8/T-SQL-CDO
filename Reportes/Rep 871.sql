----------------------------------------------------------------------------------------------------------------------------------
declare @fch_inicio datetime = '2016-01-11 00:00:00'
declare @fch_fin    datetime = '2016-02-11 23:59:59'
...
, case ing.aintiping when 1 then 'Amb' else 'Hos' end Tipo, cam.hcacodigo cama
