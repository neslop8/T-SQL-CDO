...
, coalesce(paq.sphtotpac, ser.SERVALPAC) VALOR_COPAGO_PACIENTE
--,(ser.SERVALPAC) VALOR_COPAGO_PACIENTE
...
where doc.CDTIPDOC = 0 --and fac.SFANUMFAC in ('FV000003603899')
--and cxc.GENTERCER=70 
and cxc.CRNSALDO > 0 and det.OID=114 
